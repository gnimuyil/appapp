...
PutHTML:
	cp phoneApp.html /var/www/html/class/ssd/$(USER)/apptest
	cp phoneApp.js /var/www/html/class/ssd/$(USER)/apptest
	cp phoneApp.css /var/www/html/class/ssd/$(USER)/apptest


	echo "Current contents of your HTML directory: "
	ls -l /var/www/html/class/ssd/$(USER)/apptest
