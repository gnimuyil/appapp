...
function editEntry(){
    ...
    $('#searchresults').empty();
    $.ajax({
	url: '/cgi-bin/lobo1_phoneAppComplete.cgi?editid='+editid +'&editfname='+$('#editfirst').val()+'&editlname='+$('#editlast').val()+'&editphone='+$('#editphone').val()+'&edittype='+$('#edittype').text()+'&operation=edit',
	dataType: 'text',
	success: editDone(),
...
function processDelete(){
    ...
    var id=$(this).attr('ID');
    $.ajax({
	url: '/cgi-bin/lobo1_phoneAppComplete.cgi?deleteid='+$(this).attr('ID')+'&operation=delete',
	dataType: 'text',
...
function getMatches(){
    ...
    $('#searchresults').empty();
    $.ajax({
	url: '/cgi-bin/lobo1_phoneAppComplete.cgi?find='+$('#search').val()+'&operation='+operation,
	dataType: 'text',
...
function addEntry(){
    ...
    $('#searchresults').empty();
    $.ajax({
	url: '/cgi-bin/lobo1_phoneAppComplete.cgi?afname='+$('#addfirst').val()+'&alname='+$('#addlast').val()+'&aphone='+$('#addphone').val()+'&atype='+$('#addtype').text()+'&operation='+operation,
	dataType: 'text',
	success: processAdd,
	error: function(){alert("Error: Something went wrong");}
    });
